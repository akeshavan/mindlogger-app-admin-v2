  ...
  <div>
    <b-table borderless striped responsive :items="appletItems" :fields="appletFields"
      ...
      <template slot="manage" slot-scope="data">
        ...
        <b-button variant="success" class="mt-1 mb-1" v-if="data.item.manager">Manage</b-button>
        <b-button variant="info" class="mt-1 mb-1" v-if="data.item.reviewer">Review</b-button>
      </template>
